      ...
      <div style="padding: 30px; background: #f9fafb;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #1f2937;">${data.schoolName}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-weight: bold; color: #374151;">Students:</td>
            <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #1f2937;">${data.studentCount || 'Not specified'}</td>
          </tr>
        </table>
        ${data.message ? `
