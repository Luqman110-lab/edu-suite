...
export const generateFeeCollectionReport = (
    ...
    try {
        ...
        console.error('Fee collection report error:', err);
        throw new Error(`Failed to generate fee collection report: ${err?.message || 'Unknown error'}`);
    }
};
...
export const generateExpenseReport = (
    ...
    try {
        ...
        throw new Error(`Failed to generate expense report: ${err?.message || 'Unknown error'}`);
    }
};
...
export const generateIncomeStatement = (
    ...
    try {
        ...
        throw new Error(`Failed to generate income statement: ${err?.message || 'Unknown error'}`);
    }
};
...
export const generateOutstandingFeesReport = (
    ...
    try {
        ...
        console.error('Outstanding fees report error:', err);
        throw new Error(`Failed to generate outstanding fees report: ${err?.message || 'Unknown error'}`);
    }
};
...
export const generatePaymentReceipt = (
    ...
    try {
        ...
        throw new Error(`Failed to generate receipt: ${err?.message || 'Unknown error'}`);
    }
};
...
export const generateStudentBalancesReport = (
    ...
    try {
        ...
        console.error('Student balances report error:', err);
        throw new Error(`Failed to generate student balances report: ${err?.message || 'Unknown error'}`);
    }
};
